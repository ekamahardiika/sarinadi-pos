...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .btn-primary:hover { background: var(--orange-light); transform: translateY(-1px); box-shadow: 0 6px 20px rgba(211,84,0,0.4); }
        ...
        .btn-hero-primary:hover { background: var(--orange-light); transform: translateY(-2px); box-shadow: 0 12px 40px rgba(211,84,0,0.5); }
        ...
        .btn-hero-secondary:hover { border-color: white; background: rgba(255,255,255,0.07); }
        ...
        .social-circle:hover { border-color: var(--orange); color: var(--orange); transform: translateY(-2px); }
        ...
        .hero-badge-num { font-size: 1.8rem; display: block; line-height: 1; }
        .hero-badge-text { font-size: 0.7rem; opacity: 0.85; letter-spacing: 0.05em; }
        ...
        .stat-num { font-family: 'Playfair Display', serif; font-size: 2.2rem; font-weight: 900; display: block; line-height: 1; }
        .stat-label { font-size: 0.8rem; opacity: 0.85; letter-spacing: 0.05em; text-transform: uppercase; margin-top: 4px; }
        ...
        .dish-card:hover { transform: translateY(-8px); box-shadow: 0 24px 60px rgba(211,84,0,0.15); }
        ...
        .dish-name { font-family: 'Playfair Display', serif; font-size: 1.15rem; font-weight: 700; color: var(--dark); margin-bottom: 8px; }
        .dish-desc { font-size: 0.85rem; color: var(--text-light); line-height: 1.6; }
        ...
        .about-card-float .num { font-family: 'Playfair Display', serif; font-size: 2.2rem; color: var(--orange); font-weight: 900; }
        .about-card-float .lbl { font-size: 0.78rem; color: var(--text-light); line-height: 1.3; }
        ...
        .feat-title { font-weight: 600; font-size: 0.95rem; color: var(--dark); margin-bottom: 4px; }
        .feat-desc { font-size: 0.83rem; color: var(--text-light); line-height: 1.55; }

        .about-cta { display: flex; gap: 16px; margin-top: 40px; flex-wrap: wrap; }
        ...
        .btn-orange:hover { background: var(--orange-light); transform: translateY(-2px); box-shadow: 0 8px 25px rgba(211,84,0,0.35); }
        ...
        .info-label { font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.08em; color: var(--text-light); margin-bottom: 4px; font-weight: 600; }
        .info-val { font-size: 0.95rem; color: var(--dark); font-weight: 500; }
        ...
        .kontak-cta-title em { color: var(--orange); }

        .kontak-desc { color: rgba(255,255,255,0.55); font-size: 0.95rem; line-height: 1.75; margin-bottom: 36px; }
        ...
        .kontak-channels { display: flex; flex-direction: column; gap: 20px; }
        ...
        .ch-ig { background: rgba(225,48,108,0.2); color: #e1306c; }
        .ch-grab { background: rgba(0,173,96,0.2); color: #00ad60; }

        .channel-info { flex: 1; }
        .channel-name { color: white; font-weight: 600; font-size: 0.9rem; }
        .channel-val { color: rgba(255,255,255,0.45); font-size: 0.8rem; margin-top: 2px; }

        .channel-arrow { color: rgba(255,255,255,0.3); font-size: 0.8rem; }
...
<body>
    ...
    <section id="menu" class="dishes-section">
        <div class="dishes-header">
            ...
            <p class="section-desc" style="margin: 0 auto; text-align:center;">Setiap hidangan dimasak segar setiap hari menggunakan bumbu Bali tradisional turun-temurun.</p>
        </div>
        ...
        <div class="dishes-grid">
            ...
            <div class="dish-card">
                ...
                <div class="dish-body">
                    ...
                    <div class="dish-desc">Sate khas Bali dari ikan tenggiri dan daging cincang bumbu rempah pilihan.</div>
                </div>
            </div>
    ...
    <section id="lokasi" class="lokasi-section">
        <div class="lokasi-inner">
            <div>
                ...
                <p class="section-desc" style="margin-bottom: 36px;">Mudah dijangkau di pusat Bali. Buka setiap hari dari pagi hingga hidangan habis terjual.</p>
    ...
    <section id="kontak" class="kontak-section">
        <div class="kontak-inner">
            <div>
                ...
                <p class="kontak-desc">Subscribe untuk mendapatkan promo spesial, menu baru, dan info event langsung di email Anda.</p>
    ...
    <script>
        ...
        function updateActive() {
            ...
            navLinks.forEach(a => {
                a.classList.toggle('active', a.getAttribute('data-target') === current || a.getAttribute('href') === '#' + current);
            });
        }
